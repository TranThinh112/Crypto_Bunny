...
MARKET_REGIME_DEFAULT_TOP_SYMBOLS = ("BTC/USDT:USDT", "XAU/USDT:USDT", "ETH/USDT:USDT")
    ...
    state.update(
        {
            ...
            "enableAdaptiveThreshold": bool(settings.get("enable_adaptive_threshold", True)),
            "weeklyTargetMinTrades": _safe_int(settings.get("weekly_target_min_trades"), 3),
            "weeklyTargetMaxTrades": _safe_int(settings.get("weekly_target_max_trades"), 7),
            "adaptiveScoreStep": _safe_float(settings.get("adaptive_score_step"), 3),
            "adaptiveConfidenceStep": _safe_float(settings.get("adaptive_confidence_step"), 3),
            "absoluteMinRuleScore": _safe_float(settings.get("absolute_min_rule_score"), 75),
            "absoluteMinGptConfidence": _safe_float(settings.get("absolute_min_gpt_confidence"), 80),
            "absoluteMinRiskReward": _safe_float(settings.get("absolute_min_risk_reward"), 1.5),
        }
    )
    return state
