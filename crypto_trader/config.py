...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "ai": {
        ...
        "internal": {
            ...
            "trend_scan_top_limit": 20,
            "trend_scan_strong_threshold": 65.0,
            "trend_watchlist_ttl_minutes": 180,
            "trend_watchlist_min_keep_score": 60.0,
            "trend_pending_default_ttl_minutes": 60,
            "trend_pending_min_risk_reward": 1.3,
            "trend_setup_review_ai_enabled": False,
