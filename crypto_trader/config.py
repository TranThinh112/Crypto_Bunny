...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "ai": {
        ...
        "internal": {
            ...
            "trend_scan_entry_setup_threshold": 50.0,
            "trend_scan_entry_ai_threshold": 60.0,
            "trend_scan_fast_entry_enabled": True,
            "trend_scan_fast_entry_htf_threshold": 68.0,
            "trend_scan_fast_entry_score_threshold": 52.0,
            ...
            "post_move_watch_retest_entry_score": 42.0,
