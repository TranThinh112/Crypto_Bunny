    ...
    definitions = [
        {
            ...
            "stats": [
                ...
                _module_row("total_decisions", decision_stats.get("totalDecisions"), "Tổng quyết định AI thực: LONG + SHORT + số lần GPT-5.5 từ chối hoặc xóa setup; không tính log scan thường.", attention=True),
                _module_row("total_records", decision_stats.get("totalRecords"), "Tổng số record thô trong ai_trade_decisions, bao gồm cả các lần scan NO_TRADE thường."),
