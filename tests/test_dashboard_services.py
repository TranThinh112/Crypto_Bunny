...
class SystemChecklistPayloadTests(unittest.TestCase):
    def test_returns_current_snapshot_without_rebuilding(self) -> None:
        snapshot = {
            "date": "2026-07-10",
        ...
        with patch("crypto_trader.dashboard_services._latest_system_checklist_snapshot", return_value=snapshot), patch(
    ...
    def test_uses_latest_history_snapshot_when_current_missing(self) -> None:
        snapshot = {
            "date": "2026-07-09",
            "created_at": "2026-07-09T13:05:00+00:00",
