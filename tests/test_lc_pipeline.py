...
class LcPipelineTest(TestCase):
    ...
    def test_save_state_caps_heavy_history_payloads(self) -> None:
        ...
        self.assertEqual(len(saved["one_hour_history"]), 12)
        self.assertEqual(len(saved["two_hour_history"]), 8)
        self.assertEqual(len(saved["four_hour_history"]), 8)
        ...
        self.assertEqual(len(saved["one_hour_history"][-1]["approved"]), 6)
        self.assertEqual(len(saved["one_hour_history"][-1]["rejected"]), 4)
